...
export class Favorites {
  ...
  constructor(root) {
    ...
    this.load();
    GitHubUser.search("pedroqueirozs").then((user) => console.log(user));
  }
  ...
  async add(username) {
    try {
      ...
      if (user.login === undefined) {
        throw new Error("Ùsuario não encontrado!");
      }
...
export class FavoritesView extends Favorites {
  ...
  //Funççao que faz a remoção da linha( o programa ja inicia com ela sendo executada, sendo chamada na função Update)
  removeAllTr() {
